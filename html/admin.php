<?php
/*
 * All the information related with the admin, is the html view for the admin user
 */
if (is_admin()) {
...
function datapaper_admin() {
    ...
    <div id="tabs">
        <ul>
            ...
            <li><a href="#tabs-2">See resources</a></li>  
        ...
        <div id="tabs-1">
            ...
            <form id="dp-add-source">
                ...
                <h3>Base URI</h3>
                <p><b>Example</b></p>
                <pre>http://data.semanticweb.org/conference/www/2012</pre>
    ...
    ?>
                ...
                <input type="button" id="dp-show-source" value="Test source">
            </form>
        </div>
        <div id="tabs-2">
            <h3>See Sources</h3>
            <p>In this part you can See resources</p>
    ...
    if (count($result) > 0) {
        ...
        echo '<table  class="table"><tr>' . $out1 . '</tr>' . $out3 . '</table>';
    }
    ?>
    ...
    if (count($user_source) > 0) {
        ...
        echo '<table  class="table"><tr>' . $out1 . '</tr>' . $out2 . '</table>';
    } else {
...
/*
 * Use for the ajax call, search all the source
 */
